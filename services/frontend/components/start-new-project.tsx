...
export function StartNewProject() {
  return (
    <section>
      <h2 className="text-3xl font-semibold mb-6">Start a New Project</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {projectTypes.map((type) => (
          <Link key={type.id} href={type.href}>
            <Card className="relative overflow-hidden border-neutral-800 hover:border-neutral-700 transition-colors cursor-pointer group h-[300px]">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h3 className="text-white text-2xl font-semibold mb-2">{type.title}</h3>
